...
def run_scenario():
    ...
    with open(output_file, "a") as f:
        f.write(f"[Phase 1] TCP Traffic Switching TCP traffic from {interface1_ip}\n")
    ...
    with open(output_file, "a") as f:
        f.write(f"[Phase 2] TCP Traffic Switching TCP traffic from {interface1_ip} to {interface2_ip}\n")
